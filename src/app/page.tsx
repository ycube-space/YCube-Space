...
import CommentEasterEgg from '@/components/CommentEasterEgg'
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white-100 to-transparent dark:from-black dark:via-zinc-900 dark:to-transparent lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a
